<?php /**
 * @file
 * Contains \Drupal\og_ui\Plugin\Field\FieldFormatter\OgGroupSubscribe.
 */
 ...
 *  label = @Translation("OG subscribe link"),
 *  field_types = {"list_boolean"}
 * )
 */
class OgGroupSubscribe extends FormatterBase {

  /**
   * @FIXME
   * Move all logic relating to the og_group_subscribe formatter into this
